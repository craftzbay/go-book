...
Дээрх төрлөөс `Android` нэртэй шинэ төрөл үүсгэе. Ингэхдээ шинэ `Android` төрөл нь `Person`-д байгаа бүх шинжийг авахыг хүсвэл яах вэ?  Үүнийг “Android бол Person” хэлбэрийн хамаарал гэж хэлж болно, ө.х `Person`-д байдаг шинжүүд \(талбарууд\) болон чадваруудыг \(метод\) бүгдийг нь агуулсан шинэ төрөл үүсгэнэ гэсэн үг.
